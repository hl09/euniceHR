...
class VideoForm(forms.Form):
    ...
    dept = forms.CharField(initial='',label='部门',required=False)
    ...
    jobType =forms.CharField(initial='',label='岗位分类',required=False)
    ...
    onboardDate = forms.CharField(widget=forms.DateInput(attrs={'class': 'easyui-datebox'}),label='进本单位日期',required=True,
    ...
    contractStart = forms.DateField(widget=forms.DateInput(attrs={'class': 'easyui-datebox'}),label='合同开始日期',required=True,
                             error_messages={'required': "开始日期不能为空"})
    contractEnd =forms.DateField(widget=forms.DateInput(attrs={'class': 'easyui-datebox'}),label='合同结束日期',required=True,
    ...
    flag = forms.CharField(initial='',label='标记',required=False)


    opkind = forms.CharField(initial='',label='opkind')
