...
class VideoForm(forms.Form):
    ...
    name = forms.CharField(initial='',label='姓名')
    ...
    onboardDate = forms.DateField(widget=forms.SelectDateWidget(), label='入职日期')

    opkind = forms.CharField(widget=forms.HiddenInput())
